...
slides = {
    ...
    "하네스_엔지니어링_완성_구조": lambda: wrap(
        ...
        f'  <text x="90" y="284" font-family="{FONT}" font-size="13" font-weight="700" fill="#2563eb">트리거</text>\n'
        f'  <text x="90" y="304" font-family="{FONT}" font-size="11" fill="#6b7280">언제 시작하나</text>\n'
        f'  <text x="90" y="318" font-family="{FONT}" font-size="11" fill="#9ca3af">Notion Webhook → Channels</text>\n'
    ...
    "나만의_하네스_설계_시트": lambda: wrap(
        ...
        f'  <text x="80" y="250" font-family="{FONT}" font-size="13" font-weight="700" fill="#2563eb">트리거</text>\n'
        f'  <text x="80" y="270" font-family="{FONT}" font-size="11" fill="#9ca3af">언제 시작하나?</text>\n'
        f'  <text x="80" y="287" font-family="{FONT}" font-size="11" fill="#bfdbfe">예) Notion Webhook → Channels</text>\n'
        f'  <text x="80" y="304" font-family="{FONT}" font-size="11" fill="#d1d5db">_______________</text>\n'
