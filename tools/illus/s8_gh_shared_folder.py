...
b += [path("M462 440C466 350 520 300 598 300"), doc(452, 332, 54, -12), doc(528, 262, 48, -4),
      text(436, 296, "올리기", 36, 900, ACCENT, anchor="end"), badge(304, 284, 1)]
b += [path("M1194 300C1272 300 1326 350 1330 440"), doc(1216, 258, 48, 4), doc(1286, 332, 54, 12),
