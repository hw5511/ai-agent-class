# 화면 품질 기준 — Vercel Web Interface Guidelines

> 출처: vercel-labs/web-interface-guidelines (antfu/skills 의 web-design-guidelines 가 런타임에 받아오는 원본).
> 코드를 쓰는 동안 이 규칙을 적용하고, 끝난 뒤 이 목록으로 자기 코드를 훑는다.
