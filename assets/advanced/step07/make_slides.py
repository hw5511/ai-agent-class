...
slides = {
    ...
    "Notion_실시간_대시보드": lambda: wrap(
        ...
        f'  <text x="80" y="331" font-family="{FONT}" font-size="13" fill="#374151">Demo 미팅 준비 — 목요일 오후 3시</text>\n'
        ...
        f'  <text x="80" y="375" font-family="{FONT}" font-size="13" fill="#374151">LinkedIn 타겟 페르소나 트렌드 조사</text>\n'
        ...
        f'  <text x="80" y="419" font-family="{FONT}" font-size="13" fill="#374151">Closing 계약 제안서 시트 생성</text>\n'
        ...
        f'  <text x="80" y="463" font-family="{FONT}" font-size="13" fill="#374151">신규 잠재 고객에게 첫 영업 이메일 발송</text>\n'
    ...
    "task_분류_로직_설계": lambda: wrap(
        ...
        divider(212) + "\n" +
        label(254, "분류 기준 (Sales Playbook DB 속성)") + "\n" +
        ...
        + body(330, "Channel = Video Call", x=80, color="#374151") + "\n" +
        body(354, "Stage = Demo", x=80, color="#374151") + "\n" +
        body(390, "-> google-calendar 스킬", x=80, color="#6b7280", size=13) + "\n" +
        body(414, "-> Demo 미팅 일정 자동 등록", x=80, color="#6b7280", size=13) + "\n" +
        ...
        + body(330, "Channel = LinkedIn", x=370, color="#374151") + "\n" +
        body(354, "Stage = Prospecting", x=370, color="#374151") + "\n" +
        ...
        + body(330, "Stage = Closing", x=660, color="#374151") + "\n" +
        body(354, "계약 단계 데이터 정리", x=660, color="#374151") + "\n" +
        body(390, "-> google-sheets 스킬", x=660, color="#6b7280", size=13) + "\n" +
        body(414, "-> 계약 제안서 시트 자동 생성", x=660, color="#6b7280", size=13) + "\n" +
        ...
        + body(330, "Channel = Email", x=950, color="#374151") + "\n" +
        body(354, "Stage = Prospecting", x=950, color="#374151") + "\n" +
        body(390, "-> gmail 스킬", x=950, color="#6b7280", size=13) + "\n" +
        body(414, "-> 첫 영업 이메일 자동 발송", x=950, color="#6b7280", size=13) + "\n" +
        footer_light("CLAUDE.md에 Channel/Stage -> 스킬 매핑 규칙으로 작성합니다")
    ),
    ...
    "CLAUDE_md_처리_규칙_작성": lambda: wrap(
        ...
        body(408, "task 분류 기준 (Sales Playbook DB 속성 기반):", x=80, mono=True, size=13, color="#171717") + "\n" +
        body(430, "- Channel = 'Video Call'  -> google-calendar 스킬 실행", x=80, mono=True, size=13, color="#2563eb") + "\n" +
        body(452, "- Channel = 'LinkedIn'    -> naver-datalab 스킬 실행 -> 결과 Docs DB 저장", x=80, mono=True, size=13, color="#d97706") + "\n" +
        body(474, "- Stage  = 'Closing'      -> google-sheets 스킬 실행", x=80, mono=True, size=13, color="#16a34a") + "\n" +
        body(496, "- Channel = 'Email'       -> gmail 스킬 실행", x=80, mono=True, size=13, color="#9333ea") + "\n" +
    ...
    "케이스1_캘린더_등록": lambda: wrap(
        ...
        sub("Demo 미팅 task를 캘린더에 자동으로 등록합니다") + "\n" +
        divider(212) + "\n" +
        f'  <rect x="60" y="232" width="1160" height="56" rx="8" fill="#eff6ff" stroke="#bfdbfe" stroke-width="1"/>\n'
        f'  <text x="80" y="256" font-family="{FONT}" font-size="14" font-weight="700" fill="#1e40af">Sales Playbook task 예시</text>\n'
        f'  <text x="300" y="256" font-family="{MONO}" font-size="14" fill="#374151">"Demo 미팅 준비 — 목요일 오후 3시"</text>\n'
        f'  <text x="80" y="277" font-family="{FONT}" font-size="12" fill="#6b7280">속성 감지: Channel = Video Call, Stage = Demo</text>\n' +
        label(320, "처리 흐름") + "\n" +
        ...
        f'  <text x="180" y="388" text-anchor="middle" font-family="{FONT}" font-size="12" fill="#6b7280">"목요일 오후 3시</text>\n'
        f'  <text x="180" y="404" text-anchor="middle" font-family="{FONT}" font-size="12" fill="#6b7280">Demo 미팅" 파싱</text>\n'
        ...
        footer_light("Channel=Video Call인 Demo 미팅이 자동으로 캘린더에 등록됩니다")
    ),
    ...
    "케이스2_데이터랩_조사": lambda: wrap(
        ...
        sub("LinkedIn 잠재고객 타겟 조사 task를 데이터랩으로 실행하고 결과를 Notion에 저장합니다") + "\n" +
        divider(212) + "\n" +
        f'  <rect x="60" y="232" width="1160" height="56" rx="8" fill="#fef3c7" stroke="#fde68a" stroke-width="1"/>\n'
        f'  <text x="80" y="256" font-family="{FONT}" font-size="14" font-weight="700" fill="#d97706">Sales Playbook task 예시</text>\n'
        f'  <text x="300" y="256" font-family="{MONO}" font-size="14" fill="#374151">"LinkedIn 타겟 페르소나 검색량 분석해줘"</text>\n'
        f'  <text x="80" y="277" font-family="{FONT}" font-size="12" fill="#6b7280">속성 감지: Channel = LinkedIn, Stage = Prospecting</text>\n' +
        label(320, "처리 흐름") + "\n" +
        f'  <rect x="60" y="334" width="240" height="80" rx="8" fill="#f8fafc" stroke="#e5e7eb" stroke-width="1"/>\n'
        f'  <text x="180" y="366" text-anchor="middle" font-family="{FONT}" font-size="13" font-weight="700" fill="#374151">페르소나 추출</text>\n'
        f'  <text x="180" y="388" text-anchor="middle" font-family="{FONT}" font-size="12" fill="#6b7280">"B2B SaaS 구매담당자"</text>\n'
        f'  <text x="180" y="404" text-anchor="middle" font-family="{FONT}" font-size="12" fill="#6b7280">LinkedIn 타겟 파악</text>\n'
        f'  <text x="318" y="378" text-anchor="middle" font-family="{FONT}" font-size="18" fill="#d1d5db">&#8594;</text>\n'
        f'  <rect x="336" y="334" width="240" height="80" rx="8" fill="#f8fafc" stroke="#e5e7eb" stroke-width="1"/>\n'
    ...
    "케이스3_시트_생성": lambda: wrap(
        ...
        sub("Closing 단계 계약 데이터를 구글 시트로 자동 생성합니다") + "\n" +
        divider(212) + "\n" +
        f'  <rect x="60" y="232" width="1160" height="56" rx="8" fill="#f0fdf4" stroke="#bbf7d0" stroke-width="1"/>\n'
        f'  <text x="80" y="256" font-family="{FONT}" font-size="14" font-weight="700" fill="#16a34a">Sales Playbook task 예시</text>\n'
        f'  <text x="300" y="256" font-family="{MONO}" font-size="14" fill="#374151">"Closing 단계 고객사 계약 조건 시트로 정리해줘"</text>\n'
        f'  <text x="80" y="277" font-family="{FONT}" font-size="12" fill="#6b7280">속성 감지: Stage = Closing</text>\n' +
        label(320, "처리 흐름") + "\n" +
        f'  <rect x="60" y="334" width="240" height="80" rx="8" fill="#f8fafc" stroke="#e5e7eb" stroke-width="1"/>\n'
        f'  <text x="180" y="366" text-anchor="middle" font-family="{FONT}" font-size="13" font-weight="700" fill="#374151">Closing 데이터 조회</text>\n'
        f'  <text x="180" y="388" text-anchor="middle" font-family="{FONT}" font-size="12" fill="#6b7280">Notion에서 Stage=Closing</text>\n'
        f'  <text x="180" y="404" text-anchor="middle" font-family="{FONT}" font-size="12" fill="#6b7280">고객사 목록 불러오기</text>\n'
        f'  <text x="318" y="378" text-anchor="middle" font-family="{FONT}" font-size="18" fill="#d1d5db">&#8594;</text>\n'
        f'  <rect x="336" y="334" width="240" height="80" rx="8" fill="#f8fafc" stroke="#e5e7eb" stroke-width="1"/>\n'
        f'  <text x="456" y="366" text-anchor="middle" font-family="{FONT}" font-size="13" font-weight="700" fill="#374151">데이터 정리</text>\n'
        f'  <text x="456" y="388" text-anchor="middle" font-family="{FONT}" font-size="12" fill="#6b7280">고객사/조건/금액</text>\n'
        ...
        footer_light("Closing 단계 계약 데이터가 구글 시트로 자동 정리됩니다")
    ),
    ...
    "케이스4_지메일_발송": lambda: wrap(
        ...
        f'  <text x="80" y="256" font-family="{FONT}" font-size="14" font-weight="700" fill="#9333ea">Sales Playbook task 예시</text>\n'
        f'  <text x="300" y="256" font-family="{MONO}" font-size="14" fill="#374151">"신규 잠재 고객에게 첫 영업 이메일 발송해줘"</text>\n'
        f'  <text x="80" y="277" font-family="{FONT}" font-size="12" fill="#6b7280">속성 감지: Channel = Email, Stage = Prospecting</text>\n' +
        label(320, "처리 흐름") + "\n" +
        f'  <rect x="60" y="334" width="240" height="80" rx="8" fill="#f8fafc" stroke="#e5e7eb" stroke-width="1"/>\n'
        f'  <text x="180" y="362" text-anchor="middle" font-family="{FONT}" font-size="13" font-weight="700" fill="#374151">고객 정보 조회</text>\n'
        f'  <text x="180" y="384" text-anchor="middle" font-family="{FONT}" font-size="12" fill="#6b7280">잠재 고객 정보</text>\n'
        f'  <text x="180" y="400" text-anchor="middle" font-family="{FONT}" font-size="12" fill="#6b7280">Sales Playbook에서 조회</text>\n'
        f'  <text x="318" y="378" text-anchor="middle" font-family="{FONT}" font-size="18" fill="#d1d5db">&#8594;</text>\n'
        f'  <rect x="336" y="334" width="240" height="80" rx="8" fill="#f8fafc" stroke="#e5e7eb" stroke-width="1"/>\n'
        ...
        f'  <text x="456" y="400" text-anchor="middle" font-family="{FONT}" font-size="12" fill="#6b7280">첫 영업 이메일 톤 조정</text>\n'
        f'  <text x="594" y="378" text-anchor="middle" font-family="{FONT}" font-size="18" fill="#d1d5db">&#8594;</text>\n'
        f'  <rect x="612" y="334" width="240" height="80" rx="8" fill="#f8fafc" stroke="#e5e7eb" stroke-width="1"/>\n'
    ...
    "실습_준비_Notion_task_등록": lambda: wrap(
        ...
        f'  <text x="250" y="292" font-family="{MONO}" font-size="13" fill="#374151">"Demo 미팅 준비 — 목요일 오후 3시"</text>\n'
        f'  <text x="80" y="312" font-family="{FONT}" font-size="12" fill="#6b7280">Sales Play Book DB | Channel: Video Call, Stage: Demo</text>\n'
        ...
        f'  <text x="270" y="358" font-family="{MONO}" font-size="13" fill="#374151">"LinkedIn 타겟 페르소나 검색량 분석해줘"</text>\n'
        f'  <text x="80" y="378" font-family="{FONT}" font-size="12" fill="#6b7280">Sales Play Book DB | Channel: LinkedIn, Stage: Prospecting</text>\n'
        ...
        f'  <text x="250" y="424" font-family="{MONO}" font-size="13" fill="#374151">"Closing 단계 고객사 계약 조건 시트로 정리해줘"</text>\n'
        f'  <text x="80" y="444" font-family="{FONT}" font-size="12" fill="#6b7280">Sales Play Book DB | Stage: Closing</text>\n'
        ...
        f'  <text x="260" y="490" font-family="{MONO}" font-size="13" fill="#374151">"신규 잠재 고객에게 첫 영업 이메일 발송해줘"</text>\n'
        f'  <text x="80" y="510" font-family="{FONT}" font-size="12" fill="#6b7280">Sales Play Book DB | Channel: Email, Stage: Prospecting</text>\n' +
